...
Grundsätzlich sieht das Reisediplomatie-Netzwerk bereits so aus. Limitations bzw. offene Fragen finden sich im ```script_datawrangling.Rmd```. Eine größere Abbildung ist mitgeschickt bzw. liegt in "outputs".
